...
//    Vector3D a, b;
//
//    // Введите координаты вектора a: 1 2 3
//    // Введите координаты вектора b: 4 5 6
//    a = Vector3D(1, 2, 3);
//    b = Vector3D(4, 5, 6);
//
//    assert(round(a.length() * 100) / 100 == 3.74);  // Длина вектора a
//    assert(round(b.length() * 100) / 100 == 8.77);  // Длина разности должна быть 5
//    assert(a.dotProduct(b) == 32);  // Скалярное произведение должно быть 32
//
